...
public class ServerThread extends Thread {
    ...
    public void run() {
        ...
        try {
            pw.write("已有客户端列表：" + P2PServer.connections + "\n");
            ...
            while ((info = br.readLine()) != null) {
                ...
                if (info.startsWith("newConn_")) {
                    ...
                    for (ServerThread server : P2PServer.connections) {
            ...
            P2PServer.connections.remove(this);
            // 关闭资源
            try {
                if (pw != null) {
                    pw.close();
